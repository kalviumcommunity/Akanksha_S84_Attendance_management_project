...
public class Main {
  ...
  // displaySchoolDirectory is now better placed in RegistrationService or a
  // ReportService
  ...
  public static void main(String[] args) {
    ...
    if (courseCS101.getEnrolledStudents().contains(student1)) { // Check enrollment before marking
      ...
      System.out
          .println("Cannot mark attendance: " + student1.getName() + " not enrolled in " + courseCS101.getCourseName());
    }
    ...
    if (courseCS101.getEnrolledStudents().contains(student3)) {
      ...
      System.out
          .println("Cannot mark attendance: " + student3.getName() + " not enrolled in " + courseCS101.getCourseName());
    }
